...
func check_player_win():
	if life <= 0:
		can_play_death = true
		play_death()
		get_node("Boss_3_KinematicBody/Boss_3_Col").disabled = true
		get_node("Boss_3_KinematicBody/Boss_3_Hit/Boss_3_Col_Hit").disabled = true
		get_node("Boss_3_KinematicBody/Boss_3_Sprite").visible = false
		get_node("Boss_3_KinematicBody_2/Boss_3_Col").disabled = true
		get_node("Boss_3_KinematicBody_2/Boss_3_Hit/Boss_3_Col_Hit").disabled = true
		get_node("Boss_3_KinematicBody_2/Boss_3_Sprite").visible = false
		get_node("Boss_3_KinematicBody_3/Boss_3_Col").disabled = true
		get_node("Boss_3_KinematicBody_3/Boss_3_Hit/Boss_3_Col_Hit").disabled = true
		get_node("Boss_3_KinematicBody_3/Boss_3_Sprite").visible = false
		var waiting_timer = Timer.new()
